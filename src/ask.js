...
export const check=async()=>{
    ...
    utils.green(`Yours: ${sellOrder.price}(${eppInfo}) Lowest: ${lowestPrice}(${lib.getProfitPercentage({price: lowestPrice, productCost: config.productCost})}%).`)
    

    if (code=== "ZERO_LIMIT_PROFIT_SELL_ORDER") throw new Error("Price of sell orders on the list break your profit limit.")
    if (code==="ZERO_ABOVE_COST_PRICE") throw new Error("Price of sell orders on the list all above your cost")
