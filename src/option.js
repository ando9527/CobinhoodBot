...
const BOT_CHECK_INTERVAL = process.env.BOT_CHECK_INTERVAL
  ? parseFloat(process.env.BOT_CHECK_INTERVAL)
  : 30
...
const totalPriceLimit = process.env.BOT_TOTAL_PRICE_LIMIT
  ? parseFloat(process.env.BOT_TOTAL_PRICE_LIMIT)
  : 999999999999999999999999999

if (mode === 'BID' && !process.env.BOT_OP_PERCENTAGE) throw new Error(message)
const opPercentage = process.env.BOT_OP_PERCENTAGE
  ? parseFloat(process.env.BOT_OP_PERCENTAGE)
...
const productCost = process.env.BOT_PRODUCT_COST
  ? parseFloat(process.env.BOT_PRODUCT_COST)
